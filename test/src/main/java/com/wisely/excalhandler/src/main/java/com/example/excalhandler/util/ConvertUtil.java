...
public final class ConvertUtil {
    ...
    public  static String[] objectToStringList(Object obj){
    	...
    	if(obj instanceof JSONArray){
    		...
    		ArrayList<String> list=(ArrayList<String>) array.toJavaList(String.class);
    		return arrayListToString(list);
    	}
    	return null;
    }
    /**
     * ArrayList与string[]的转换
     */
    ...
    /**
     * ArrayList与Object[]的转换
     */
    public static Object[] arrayListToObject(ArrayList<Object> list){
    	if(!ValidUtil.valid(list)){
    		return null;
    	}
