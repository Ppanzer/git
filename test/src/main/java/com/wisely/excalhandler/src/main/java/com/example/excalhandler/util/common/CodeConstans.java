...
public interface CodeConstans {
    ...
    public interface REDIS_TOKEN_SIGN {
        ...
        /** VERIF_SIGN_COUNT */
        public static final Integer VERIF_SIGN_COUNT = 4;//4表示的是五次
        
        /** PIC_VERIF_NEED */
        public static final String PIC_VERIF_NEED = "1";
        
        /** PIC_VERIF_NOT_NEED */
        public static final String PIC_VERIF_NOT_NEED = "0";
        
        /** IP_FAIL */
        public static final String IP_FAIL="IP_FAIL"; 
        /** 登录最大容忍错误次数 */
    	public static int ALLOW_LOGIN_FAIL_TIMES = 5;
    }
